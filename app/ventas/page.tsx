...
export default function VentasPage() {
  ...
  // ✅ FIX: eliminado setDetalle(null) para que el panel quede abierto y muestre los datos actualizados
  const handleGuardarEdicion = async (id:string) => {
    ...
    setEditando(null)
    // ✅ FIX: NO cerramos el detalle → el usuario ve los datos actualizados
    refresh()
  }
            ...
            <table style={{width:'100%',borderCollapse:'collapse',fontSize:12}}>
              ...
              <tbody>
                {ventas.map((v:any)=>{
                  ...
                  return (
                    // ✅ FIX: React.Fragment con key en lugar de <> para que React reconcilie correctamente
                            ...
                            <div style={{background:'#0f1f3d',borderTop:'1px solid #1e3a5f',padding:'20px 24px'}}>
                              {!isEditing ? (
                                ...
                                <div onClick={e=>e.stopPropagation()}>
                                  ...
                                  <div style={{display:'flex',gap:8}}>
                                    {/* ✅ FIX: stopPropagation para evitar que el click burbujee al <tr> padre */}
